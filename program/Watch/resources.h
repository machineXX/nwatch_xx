...
extern const byte menu_bluetooth[];
...
extern unsigned char astronaut_bmp[10][312];
extern unsigned char weather_bmp[6][200];
extern unsigned char weather_bmp_24[6][84];
extern uint8_t vertices[1440][3];
// Alarm icon
