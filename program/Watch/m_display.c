...
static void setBrightness()
{
	...
	switch(brightness)           //锟斤拷锟矫伙拷锟斤拷锟斤拷色
	{
	...
	OLED_WR_Byte(0x81,OLED_CMD);//--set contrast control register    // 锟斤拷锟矫对比讹拷
	OLED_WR_Byte(_brightness,OLED_CMD);// Set SEG Output Current Brightness // 1~255; 默锟斤拷0x7f, 越锟斤拷越锟斤拷
